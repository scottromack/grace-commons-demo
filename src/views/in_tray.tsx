  ...
  return (
    <Layout title="In-tray — Grace Commons" currentActor={actor} actors={actors}>
      <div class="flex items-center justify-between mb-6">
        <h1 class="text-xl font-semibold text-gray-800">In-tray</h1>
          ...
          <table class="w-full text-sm">
            <thead class="bg-gray-50 border-b border-gray-200 text-left">
              <tr>
                ...
                <th class="py-3 px-4 font-medium text-gray-600">Submitted by</th>
                <th class="py-3 px-4 font-medium text-gray-600">Chain</th>
            ...
            <tbody>
              {items.map((item) => (
                <tr class="border-b border-gray-100 last:border-0 hover:bg-gray-50">
                  ...
                  <td class="py-3 px-4 text-xs text-gray-500">{item.scope}</td>
                  <td class="py-3 px-4 text-gray-500">{item.submitter_display_name}</td>
                  <td class="py-3 px-4">
